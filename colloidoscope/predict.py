...
def detect(input_array:np.ndarray, diameter:Union[int, list], model:torch.nn.Module=None, weights_path:Union[str, Path] = None, 
            patch_overlap:tuple=(16, 16, 16), roiSize:tuple=(64,64,64), label_size:tuple=(60,60,60), post_processing:str="tp",
